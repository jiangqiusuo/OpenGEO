...
更多说明见 [Quickstart](docs/quickstart.md)、[API 开发者入口](docs/api-reference.md)、[公共契约](docs/contracts.md)、[版本与兼容策略](docs/versioning.md)、[变更日志](CHANGELOG.md) 和 [OpenAPI 文档](openapi/openapi.json)。机器可读入口见仓库根目录的 [`llms.txt`](llms.txt)。
